...
public class ExternalGroupOperatorDescriptor extends AbstractOperatorDescriptor {
    ...
    /* (non-Javadoc)
     * @see edu.uci.ics.hyracks.api.dataflow.IOperatorDescriptor#contributeTaskGraph(edu.uci.ics.hyracks.api.dataflow.IActivityGraphBuilder)
     */
    @Override
    ...
    private class MergeActivity extends AbstractActivityNode {
        ...
        public IOperatorNodePushable createPushRuntime(final IHyracksStageletContext ctx,
            ...
            final IAggregatorDescriptor currentWorkingAggregator = aggregatorFactory.createAggregator(ctx,
            ...
            IOperatorNodePushable op = new AbstractUnaryOutputSourceOperatorNodePushable() {
                    ...
                    try {
                        ...
                        for (int i = 0; i < inFrames.size(); i++) {
                            ...
                            if (runFileReaders[runIndex].nextFrame(inFrames.get(runIndex))) {
                                // Initialize the tuple accessor for this run file
                ...
                private void setNextTopTuple(int runIndex, int[] tupleIndices, RunFileReader[] runCursors,
                    ...
                    // Check whether the run file for the given runIndex has more tuples
                ...
                private int compareFrameTuples(IFrameTupleAccessor fta1, int j1, IFrameTupleAccessor fta2, int j2) {
                    ...
                    for (int f = 0; f < keyFields.length; ++f) {
                        // Note: Since the comparison is only used in the merge phase, 
                        // all the keys are clustered at the beginning of the tuple.
                        int fIdx = f;
