...
import edu.uci.ics.hyracks.dataflow.std.group.hybridhash.prepartitioning.HybridHashGroupWithMiniBloomFilterOperatorDescriptor;
import edu.uci.ics.hyracks.dataflow.std.sort.ExternalSortOperatorDescriptor;

public class HybridHashGroupWithMiniBloomFilterIntegrationTest extends AbstractIntegrationTest {
    ...
    public void singleKeySumHybridHashTest() throws Exception {
        ...
        HybridHashGroupWithMiniBloomFilterOperatorDescriptor grouper = new HybridHashGroupWithMiniBloomFilterOperatorDescriptor(spec, keyFields, framesLimit,
        ...
        AbstractSingleActivityOperatorDescriptor printer = getPrinter(spec, "singleKeySumHybridHashTest");
    ...
    public void singleKeyAvgHybridHashTest() throws Exception {
        ...
        AbstractSingleActivityOperatorDescriptor printer = getPrinter(spec, "singleKeyAvgHybridHashTest");
    ...
    public void singleKeyMinMaxStringHybridHashTest() throws Exception {
        ...
        AbstractSingleActivityOperatorDescriptor printer = getPrinter(spec, "singleKeyMinMaxStringHybridHashTest");
    ...
    public void multiKeySumHybridHashTest() throws Exception {
        ...
        HybridHashGroupWithMiniBloomFilterOperatorDescriptor grouper = new HybridHashGroupWithMiniBloomFilterOperatorDescriptor(spec, keyFields, framesLimit,
                ...
                new IBinaryHashFunctionFamily[] { ByteBasedBinaryHashFunctionFamily.INSTANCE,
                        ByteBasedBinaryHashFunctionFamily.INSTANCE }, 0, new UTF8StringNormalizedKeyComputerFactory(),
                new MultiFieldsAggregatorFactory(new IFieldAggregateDescriptorFactory[] {
        ...
        AbstractSingleActivityOperatorDescriptor printer = getPrinter(spec, "multiKeySumHybridHashTest");
    ...
    public void multiKeyMinMaxStringHybridHashTest() throws Exception {
        ...
        HybridHashGroupWithMiniBloomFilterOperatorDescriptor grouper = new HybridHashGroupWithMiniBloomFilterOperatorDescriptor(spec, keyFields, framesLimit,
                ...
                new MultiFieldsAggregatorFactory(new IFieldAggregateDescriptorFactory[] {
                        ...
                        storedKeyFields, new IFieldAggregateDescriptorFactory[] {
                                new IntSumFieldAggregatorFactory(2, false),
        ...
        AbstractSingleActivityOperatorDescriptor printer = getPrinter(spec, "multiKeyMinMaxHybridHashTest");
