...
public class AvgFieldAggregateAggregatorFactory implements IFieldAggregateDescriptorFactory {
    ...
    public AvgFieldAggregateAggregatorFactory(int aggField, boolean useObjectState) {
