...
public class HybridHashGroupWithMiniBloomFilterOperatorDescriptor extends AbstractSingleActivityOperatorDescriptor {
    ...
    public HybridHashGroupWithMiniBloomFilterOperatorDescriptor(JobSpecification spec, int[] keyFields, int framesLimit,
    ...
    public IOperatorNodePushable createPushRuntime(final IHyracksTaskContext ctx,
        ...
        final double fudgeFactor = HybridHashGroupHashTableWithMiniBloomFilter.getHashtableOverheadRatio(tableSize, frameSize,
                framesLimit, userProvidedRecordSizeInBytes) * FUDGE_FACTOR_ESTIMATION;

        return new AbstractUnaryInputUnaryOutputOperatorNodePushable() {

            HybridHashGroupHashTableWithMiniBloomFilter topProcessor;
            ...
            private int getNumberOfPartitions(int tableSize, int framesLimit, long inputKeySize, double factor) {
                ...
                int hashtableHeaderPages = HybridHashGroupHashTableWithMiniBloomFilter.getHeaderPages(tableSize, frameSize);
            ...
            public void open() throws HyracksDataException {
                ...
                topProcessor = new HybridHashGroupHashTableWithMiniBloomFilter(ctx, framesLimit, tableSize, topPartitions, keyFields, 0,
            ...
            private void processRunFiles(IFrameReader runReader, int inputCardinality, int runLevel)
                ...
                HybridHashGroupHashTableWithMiniBloomFilter processor = new HybridHashGroupHashTableWithMiniBloomFilter(ctx, framesLimit, tableSize,
             ...
             * @throws HyracksDataException
             */
            private void finishAndRecursion(HybridHashGroupHashTableWithMiniBloomFilter ht, long inputRawRecordCount,
                ...
                while (!generatedRunReaders.isEmpty()) {
                    ...
                    if ((checkFallback && runKeyCardinality > HYBRID_FALLBACK_THRESHOLD * inputCardinality)
                        ...
                        Logger.getLogger(HybridHashGroupWithMiniBloomFilterOperatorDescriptor.class.getSimpleName()).warning(
