...
public class AvgFieldPartialMergeAggregatorFactory implements IFieldAggregateDescriptorFactory {
    ...
    public AvgFieldPartialMergeAggregatorFactory(int aggField, boolean useObjectState) {
    ...
    public IFieldAggregateDescriptor createAggregator(IHyracksTaskContext ctx, RecordDescriptor inRecordDescriptor,
        ...
        return new IFieldAggregateDescriptor() {
            ...
            public void outputPartialResult(DataOutput fieldOutput, byte[] data, int offset, AggregateState state)
                ...
                throw new HyracksDataException("This should not be called.");
            }
