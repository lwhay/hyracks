...
public class AvgFieldFinalMergeAggregatorFactory implements IFieldAggregateDescriptorFactory {
    ...
    public AvgFieldFinalMergeAggregatorFactory(int aggField, boolean useObjectState) {
