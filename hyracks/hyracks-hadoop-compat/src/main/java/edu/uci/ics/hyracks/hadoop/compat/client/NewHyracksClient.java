...
public class NewHyracksClient {
    ...
    public NewHyracksClient(Properties clusterProperties) throws Exception {
    ...
    private void initialize(Properties properties) throws Exception {
        ...
        connection = new HyracksConnection(clusterController, 39000);
    ...
    public NewHyracksClient(String clusterConf, char delimiter) throws Exception {
    ...
    public NewHyracksRunningJob submitJob(String applicationName, JobSpecification spec) throws Exception {
        ...
        NewHyracksRunningJob runningJob = new NewHyracksRunningJob(jobId, spec, this);
        return runningJob;
    }   

    public NewHyracksRunningJob submitJob(String applicationName, JobSpecification spec, Set<String> userLibs)
            throws Exception {
