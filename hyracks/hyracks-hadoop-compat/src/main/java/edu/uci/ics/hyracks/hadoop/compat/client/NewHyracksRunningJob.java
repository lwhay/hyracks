...
public class NewHyracksRunningJob implements RunningJob {
    ...
    public NewHyracksRunningJob(JobId jobId, IOperatorDescriptorRegistry jobSpec, NewHyracksClient newhyracksClient) {
        this.spec = jobSpec;
        this.jobId = jobId;
    ...
    public org.apache.hadoop.mapred.JobID getID() {
        return (org.apache.hadoop.mapred.JobID) new JobID(this.jobId.toString(), 1); 
    }   
