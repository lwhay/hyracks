...
public class NCConfig implements Serializable {
    ...
    @Option(name = "-cluster-net-ip-address", usage = "Address to bind cluster listener", required = true)
    ...
    @Option(name = "-data-ip-address", usage = "Address to bind data listener", required = true)
    public String dataIPAddress;

    @Option(name = "-result-ip-address", usage = "Address to bind dataset result distribution listener", required = true)
