...
public class BTreeCountingSearchCursor implements ITreeIndexCursor {
    ...
    public ITupleReference getTuple() {
        ...
        try {
            tb.addField(IntegerSerializerDeserializer.INSTANCE, new Integer(count));
        } catch (HyracksDataException e) {
            e.printStackTrace();
        }
        ArrayTupleReference countTuple = new ArrayTupleReference();
        countTuple.reset(tb.getFieldEndOffsets(), tb.getByteArray());
        return countTuple;
    }
