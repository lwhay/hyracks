...
public abstract class AbstractInlineVariablesRule implements IAlgebraicRewriteRule {
    ...
    protected abstract boolean performFinalAction() throws AlgebricksException;

    protected abstract boolean performBottomUpAction(AbstractLogicalOperator op) throws AlgebricksException;
