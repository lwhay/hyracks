...
public class DummyOperatorsBenchmarkingClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < options.testCount; i++) {
            ...
            job = createJob(options.chainLength, splitPattern.split(options.inNodeSplits), splitPattern.split(options.outNodeSplits));
    ...
    private static JobSpecification createJob(int chainLength, String[] inNodes, String[] outNodes) {
