...
public class ReduceWriter<K2, V2, K3, V3> implements IFrameWriter {
    ...
    public ReduceWriter(IHyracksContext ctx, HadoopHelper helper, int[] groupFields,
        ...
        accessor0 = new FrameTupleAccessor(ctx, recordDescriptor);
        accessor1 = new FrameTupleAccessor(ctx, recordDescriptor);
