...
public class OnlineFileSplit extends InputSplit implements Writable {
    private Path file;
    private long start;
    private long length;
    private int blockId;
    ...
    public OnlineFileSplit() {
    }

    public OnlineFileSplit(int blockId, Path file, long start, long length, String[] hosts, long schedule_time) {
